...
from view.nets.yolo import YoloBody
from view.utils.utils import (cvtColor, get_classes, preprocess_input,
                         resize_image, show_config)
from view.utils.utils_bbox import DecodeBox
...
class YOLO(object):
    ...
    def generate(self, onnx=False):
        ...
        print('{} model_data, and classes loaded.'.format(self.model_path))
        if not onnx:
            if self.cuda:
    ...
    def convert_to_onnx(self, simplify, model_path):
        ...
        # Checks
        model_onnx = onnx.load(model_path)  # load onnx model_data
        onnx.checker.check_model(model_onnx)  # check onnx model_data
        ...
        print('Onnx model_data save as {}'.format(model_path))
